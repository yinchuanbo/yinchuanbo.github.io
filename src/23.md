---
title: 为什么 JavaScript 的 Map 比 Object 更好
category: JavaScript
date: 2025-07-11 14:00:16
---
...
```js
map.set(key, value);  // Add a key-value pair
...
```js
const map = new Map();
console.log(map.constructor); // utputs Map constructor
