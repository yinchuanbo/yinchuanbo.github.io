---
title: CSS accent-color 一键定制表单元素的主题色，告别样式冗余
category: CSS
date: 2025-08-11 15:39:47
---
...
![Screen-2025-08-11-142455.gif](../images/5b954a709be9b7eca78f13fd7458d597.awebp)

效果：勾选框的勾选标记和选中背景会显示为红色，未选中时仍保持默认样式（不影响未激活状态）。

### 2.2 单选按钮（input \[type="radio"\]）
...
![Screen-2025-08-11-142549.gif](../images/425b4e7556a4a5ef4e049ffac56c7380.awebp)
...
![WX20250811-142630@2x.png](../images/8ec6669eb759384e42700880f208bddb.awebp)

效果：进度条的 70% 已完成部分显示为橙色，未完成部分为默认灰色。

### 2.4 范围输入（input \[type="range"\]）
...
![Screen-2025-08-11-143527 (2).gif](../images/6b8c24698b7eb9e4d9dc3f2c23b13ba0.awebp)
...
![Screen-2025-08-11-143828 (1).gif](../images/663fb59aa63adbf9a72223a355306c18.awebp)
...
![Screen-2025-08-11-144016 (1).gif](../images/8d5e2d66cb60e3b5fe4679ea44ac3b77.awebp)
