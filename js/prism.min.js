/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-funky&languages=markup+css+clike+javascript+bash+css-extras+json+markdown+nginx+powershell+python+jsx+tsx+regex+rust+sass+scss+typescript+wasm+xml-doc&plugins=line-highlight+line-numbers+custom-class+show-language+highlight-keywords+inline-color+toolbar+copy-to-clipboard */
