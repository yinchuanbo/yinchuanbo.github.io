...
const wrapperLeftMask = document.querySelector(".wrapper__left_mask");
const wrapperLeftMaskContent = document.querySelector(
  ".wrapper__left_mask_content"
);
const closeLeftDom = document.querySelector(".wrapper__left_mask_close");
